...
func TestProcess(t *testing.T) {
	...
	test.IsEqualString(t, result.Url, "http://127.0.0.1:53843/d?id="+result.FileInfo.Id)
	test.IsEqualString(t, result.UrlFilename, "http://127.0.0.1:53843/d/"+result.FileInfo.Id+"/"+result.FileInfo.Name)
